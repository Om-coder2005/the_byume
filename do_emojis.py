...
emoji_map = {
    ...
    "🖼️": '<iconify-icon icon="lucide:image"></iconify-icon>',
    "⭐": '<iconify-icon icon="lucide:star"></iconify-icon>',
    "📝": '<iconify-icon icon="lucide:file-text"></iconify-icon>',
    "🌟": '<iconify-icon icon="lucide:sparkles"></iconify-icon>',
    "👁️": '<iconify-icon icon="lucide:eye"></iconify-icon>',
    ...
    "✂️": '<iconify-icon icon="lucide:scissors"></iconify-icon>',
    ...
    "✍️": '<iconify-icon icon="lucide:pen-tool"></iconify-icon>',
    ...
    "🗝️": '<iconify-icon icon="lucide:key"></iconify-icon>',
    ...
    "✉️": '<iconify-icon icon="lucide:mail"></iconify-icon>',
...
def replace_emojis(text):
    for emoji, icon in emoji_map.items():
        # Only replace if the emoji actually exists
        if emoji in text:
